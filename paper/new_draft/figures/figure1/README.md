...
| | A_staggered | B_walls | C_gauntlet |
|---|---|---|---|
| obstacles | two 2-row blocks, staggered | wall from the bottom, wall from the top | three alternating edge walls |
| corridor | 1000 m | 1000 m | 1100 m |
| landmark | (600, −300) | (700, −330) | (800, +220) |
| bound (shipped `tight/`) | 2.0 | 2.0 | 2.2 |
| primary, lattice | **1200** (= blind 1200; alone 1400) | **1300** (= blind 1300; alone 1500) | **1400** (= blind 1400; alone 1500) |
| primary, spline | **1065.7** (blind 1063.6; alone 1098.8) | **1120.8** (blind 1113.3; alone 1189.7) | 1253.1 (blind 1166.2; alone 1229.4) |
| primary σ at goal | 2.000 | 2.000 | 2.200 |
| rendezvous (arc, dist, w) | 900 m, 102 m, 0.32 | 900 m, 99 m, 0.62 | 1000 m, 103 m, 0.24 |
| primary σ across it | 2.19 → 1.86 | 2.23 → 1.74 | 2.43 → 1.89 |
| verdict | clean, minimal | **strongest picture** | most obstacles, weakest rejoin |
