...
\begin{figure}[t]
  ...
  \caption{What each planner pays for reliability, over the 50 randomized
    ...
    most, walks the least. Marker shape and dash pattern identify the planner;
    each line is the trajectory it sweeps out as the terminal uncertainty bound
    tightens, and the marker fills step through the shared key below, green
    (loose) to dark violet (tight). Ours holds the top-left corner: it is still solving 80\% of the
