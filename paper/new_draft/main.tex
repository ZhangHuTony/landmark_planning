...
\begin{figure}[t]
  ...
  \caption{What each planner pays for reliability, over the 50 randomized
    ...
    better}. Marker shape identifies the planner, and each line is the
    trajectory it sweeps out as the terminal uncertainty bound tightens ---
    read along the shared color scale below, green (loose) to dark violet
    (tight). Ours holds the top-right corner: it is still solving 80\% of the
