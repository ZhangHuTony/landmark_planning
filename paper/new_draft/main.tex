...
\begin{figure}[t]
  ...
  \caption{Fraction of the 50 randomized scenarios each planner solved as the
    ...
    ramp, from its base hue (paths at the reference length) to a deeper,
    contrasting hue (long detours); the strip below the axis is the shared
    scale, and marker shape repeats the planner identity.}
