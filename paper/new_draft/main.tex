...
\begin{figure}[t]
  ...
  \caption{Fraction of the 50 randomized scenarios each planner solved as the
    ...
    lone-agent reference length $L_\mathrm{ref}$, on the shared scale at the
    right. One ramp serves every planner, so the same color means the same
    detour on every line. Ours (gold) is still solving 80\% of the scenarios at
